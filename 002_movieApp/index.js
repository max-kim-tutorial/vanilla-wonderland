...
function cardWidth(card, matching) {
  if (matching) card.style.width = "92.5%";
  else card.style.width = "40%";
}
...
function cardStyle(card) {
  ...
  card.style.boxShadow =
    "0 8px 38px hsla(0,0%,52.2%,.3), 0 5px 12px hsla(0,0%,52.2%,.22)";
}
...
function posterWidth(poster, matching) {
  if (matching) poster.style.width = "100%";
  else poster.style.width = "30%";
}
...
function posterStyle(poster) {
  ...
  poster.style.boxShadow =
    "-10px 19px 38px rgba(83,83,83,.3), 10px 15px 12px rgba(80,80,80,.22)";
}
